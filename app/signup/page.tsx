...
export default function Login({
    ...
    const signUp = async (formData: FormData) => {
        ...
        if (error) {
            console.error("/login?message=Could not authenticate user");
        }

        console.error("/login?message=Check email to continue sign in process");
    };
    ...
    return (
        <div className="flex-1 flex flex-col w-full px-8 sm:max-w-md justify-center gap-2">
            ...
            <div
                className={
                    "w-screen h-screen grid place-items-center absolute top-0 left-0"
                }
            >
                <form
                ...
                >
                    ...
                    <label className="text-sm text-second" htmlFor="name">
                        Your Name
                    </label>
                    <input
                        className="input"
                    ...
                    <input
                        ...
                        required
                    />
                    <button className="button background-gradient">Sign Up</button>
                    <p
                        id="errorMessage"
